...
try {
	...
	$p_contra = $_POST['pass'];
	$contraseña = $p_contra;
	$consulta_usuario = $conexion->prepare("SELECT id_usuario, usuario, pass, nombre, ap_paterno,  activo FROM usuarios WHERE usuario = '$p_user' AND pass = '$contraseña' AND activo = '1'");
