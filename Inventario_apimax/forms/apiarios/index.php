          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li id="modulo_modulos" class="nav-item has-treeview menu-open" hidden>
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="../apiarios/index.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
                    <p>Apiarios</p>
                  </a>
                </li>
        ...
        <div class="container-fluid">
          ...
          <div class="col-sm-12 col-md-12 col-lg-12">
            ...
            <div class="card card-warning">
              ...
              <!-- /.card-header -->
              <!-- form start -->
              <div id="formApiario" class="card-body">
                <form action="#" method="POST" id="frmApiario" data-action="agregar">
                  <input type="hidden" name="id_apiario" id="id_apiario">
                  <div class="card-body">
                    <div class="row">
                      <div class="form-group col-sm-12 col-md-12">
                        <label for="nombre">Nombre:</label>
                        <input type="text" class="form-control" id="nombre" name="nombre" placeholder="Ingresa el nombre del apiario..." required>
                      </div>
                    </div>
                  </div>
                  <!-- /.card-body -->
                ...
                <div class="row">
                  <div class="col-md-12">
                    <div class="table-responsive">
                      ...
                      <table id="tabla_apiario" class="table table-bordered table-striped">
  ...
  <script>
    $(document).ready(function() {
      $("#search").keyup(function() {
        _this = this;
        $.each($("#tabla_apiario tbody tr"), function() {
