...
$datos = $conexion->prepare("SELECT u.id_usuario, CONCAT(p.nombre,' ', p.ap_paterno,' ', p.ap_materno)AS NameFull, u.usuario, u.tipo_usuario, u.activo, u.id_persona
FROM usuarios u
...
try
{
    ...
    while($row = $datos->fetch(PDO::FETCH_NUM))
    {
        ...
        <input type="hidden" name="id_persona_<?php echo $id_usuario; ?>" id="id_persona_<?php echo $id_usuario; ?>" value="<?php echo htmlspecialchars($row[5], ENT_QUOTES, 'UTF-8');?>" >
            ...
            <td class="text-center"><a href="estado.php?id_usuario=<?php echo (int) $id_usuario;?>&estado=<?php echo (int) $activo;?>" class="btn btn-secondary"><?php echo $estado;?></a></td>
